        ...
        @role('admin')
            ...
            <div class="space-y-2">
                ...
                <div x-show="open.adminMaster" class="space-y-1">
                    ...
                    <a href="{{ route('admin.expense_categories.index') }}" class="flex items-center rounded-xl px-3 py-2.5 transition {{ request()->routeIs('admin.expense_categories.*') ? 'bg-white text-slate-900 shadow-sm font-semibold' : 'text-blue-50 hover:bg-white/10' }}">Kategori Pengeluaran</a>
