...
@section('content')
    ...
    <form method="POST" action="{{ route(request()->routeIs('manager.*') ? 'manager.employees.store' : 'admin.employees.store') }}" class="bg-white border rounded-lg p-4 space-y-3 max-w-2xl">
        @csrf
